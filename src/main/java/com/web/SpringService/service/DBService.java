...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		Cliente cli1 = new Cliente(null, "Jonas", "jonasmourat9090@gmail.com", "18402827705", TipoCliente.PESSOA_FISICA,
				bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli1.addPerfils(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Maria Silva", "jonasmourat@gmail.com", "36378912377",
